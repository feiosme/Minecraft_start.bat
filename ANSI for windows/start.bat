...
rem 内存优化
rem 使用垃圾回收器: -XX:+UseCompressedOops
...
echo 启动目录 : %cd%
echo -------------------------------------------------
if "%PROCESSOR_ARCHITECTURE:~0,3%" equ "x86" (echo 32位) else (echo 64位)
echo 处理器核心数：%NUMBER_OF_PROCESSORS% 系统：%OS%
